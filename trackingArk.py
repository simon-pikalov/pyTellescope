...
class telescopeTracker:
    ...
    def __init__(self,telescopeEnabled = False):
        self.telescopeEnabled = telescopeEnabled
        if (telescopeEnabled):
            self.telescope = Telcontrol.Telcontrol()
            time.sleep(2)
    ...
    def init_camera(self):
        ...
        self.out = cv2.VideoWriter(self.output_folder + self.output_file,cv2.VideoWriter_fourcc('M','J','P','G'), 10, (frame_width,frame_height))
